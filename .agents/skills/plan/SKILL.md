...
- Requests to execute, build, or debug directly: explain that Plan itself executes nothing — execution belongs to `/velo:run`, from a plan frozen and approved here — and offer to plan it; never auto-execute, and never start, invoke, or simulate Run.

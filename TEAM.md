...
|---|---|---|---|
| **distinguished-engineer** | `agents/distinguished-engineer.md` | Technical bar, architecture review — peer to EM. Build-time arbiter after EDD approval | deep-reasoning |

...
- **No starting another mode** — Plan never invokes, hands off to, or role-plays Run; a frozen plan waits for the user to start `/velo:run` themselves
...
- `Planned-via:` — set at carrier creation and never rewritten: `/velo:plan`.

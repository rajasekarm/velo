...
- **`Mode: prd`** (default — used by `/velo:new`): you produce a full PRD at `.velo/tasks/<slug>/prd.md`. All workflow steps below apply.
...
### Step 2 — Corner-case interrogation pass (all modes)

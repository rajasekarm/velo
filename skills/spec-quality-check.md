...
description: Consumer-side adversarial audit of a spec (a PRD) before any design or implementation begins. Encodes a 5-finding taxonomy and 5 quality criteria. Returns STATUS:SPEC_OK or STATUS:SPEC_REWORK_NEEDED with prioritized findings. Loaded by the agent that consumes the spec.
---
# Spec Quality Check
...
The caller (TL workflow Step 0 in `/velo:new`) reads the first line of your output. The contract is:
